...
function randSequence(options) {
  if (options != null && options.charType && !(options != null && options.chars)) {
    switch (options.charType) {
      ...
      case 'special':
        return fake(() => generator$1(options == null ? void 0 : options.size, specialChars), options);
      default:
...
function randFileName(options) {
  ...
  return fake(() => `${randElement(data$1S)}.${ext}`, options);
}
...
function randCreditCardNumber(options) {
  ...
  const brand = (_options$brand = options == null ? void 0 : options.brand) != null ? _options$brand : rand(Object.keys(data$1w));
  const formats = (_data$find = data$1w.find(card => card.brand === brand)) == null ? void 0 : _data$find.formats;
...
function randFirstName(options) {
  ...
  const names = withAccents ? locale ? locale == null ? void 0 : locale.withAccents[gender] : data$1g.withAccents[gender] : locale ? locale == null ? void 0 : locale.withoutAccents[gender] : data$1g.withoutAccents[gender];
...
function randFloat(options) {
  ...
  function factory() {
    ...
    if (stringfiedResult.includes('.') && stringfiedResult.split('.')[1].length === o.fraction) {
      return result;
    } else {
      return factory();
    }
...
var _Object$keys$1;
const totalOrigins = (_Object$keys$1 = Object.keys(data$17)) == null ? void 0 : _Object$keys$1.length;
/**
...
function randGender(options) {
  return fake(options != null && options.code ? data$13 : data$14, options);
}
...
function randLanguage(options) {
  return fake(options != null && options.code ? data$U : data$V, options);
}
 ...
 *
 */
function randMotorcylceManufacturer(options) {
